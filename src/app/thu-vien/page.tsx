...
export const metadata: Metadata = {
  ...
  description:
    'Tải bộ starter kit tiếng Việt cho Hermes Agent: SOUL.md tiếng Việt, 100 prompt theo nghề, bộ skills chọn lọc. Miễn phí.',
  ...
  return (
    <div className="wrap py-12">
      ...
      <p className="mb-8 max-w-2xl text-[16px] text-ink-soft">
        ...
        Việt, tải về là dùng. Để lại email, chúng tôi gửi trực tiếp vào hộp thư.
      </p>
      ...
      <div className="card max-w-xl p-6">
        <h2 className="mb-1 text-[18px] font-bold">Nhận bộ starter kit</h2>
